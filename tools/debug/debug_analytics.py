#!/usr/bin/env python3
"""
Debug script to check why analytics is returning mock data
"""
...
try:
    ...
    if data:
        ...
        # Check if it's mock data (mock titles usually contain words like "Discovering", "Embracing", etc.)
...
print("\n⚡ Testing get_all_sermon_analytics() directly...")
try:
...
print("\n⚡ Testing _fetch_real_data() directly...")
try:
    data = analytics._fetch_real_data()
    print(f"✅ Received {len(data)} sermons")
    if data:
        first_sermon = data[0]
        print(f"📝 First sermon title: {first_sermon.get('title', 'N/A')}")
