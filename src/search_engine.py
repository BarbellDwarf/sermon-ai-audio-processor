...
class SermonSearchEngine:
    ...
    def _fts_search(self, conn: sqlite3.Connection, query: str, filters: Optional[Dict[str, Any]]) -> List[SearchResult]:
    ...
    def _like_search(self, conn: sqlite3.Connection, query: str, filters: Optional[Dict[str, Any]]) -> List[SearchResult]:
